...
1. **Clone the repository**
   ```bash
   git clone [https://github.com/fatihkayaci/finance-manager-csharp](https://github.com/fatihkayaci/finance-manager-csharp)
...
3.  **Access the Application**
      ...
      - **API (Swagger):** [http://localhost:5055/swagger](https://www.google.com/search?q=http://localhost:5055/swagger)
